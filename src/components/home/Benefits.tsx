  ...
  const benefits = [
    {
      ...
      description:
        "Just like your car needs regular maintenance, your solar panels collect dirt, dust, and other pollutants from the air. Regular cleaning ensures optimal performance.",
      icon: Sun,
      details: [
    ...
    },
    {
      ...
      description:
        "We use proprietary solar panel cleaning solutions and processes to quickly and gently cut through grime, leaving your panels streak-free and spotless.",
      icon: Droplets,
      details: [
    ...
    },
    {
      ...
      description:
        "With regular maintenance, your solar panels will always be giving you 100% of their ability to produce your power and reduce your power bill.",
      icon: Zap,
      details: [
    ...
    },
    {
      ...
      description:
        "On top of cleaning service, we offer a 'tune up' maintenance program checking connections and operations of your system - repair or replace any parts needed.",
      icon: Shield,
      details: [
      ...
      <div className="container px-4 md:px-6">
        ...
        >
          ...
          <p className="mt-4 text-xl text-blue-200 max-w-3xl mx-auto">
            Discover why regular maintenance and cleaning are crucial for
